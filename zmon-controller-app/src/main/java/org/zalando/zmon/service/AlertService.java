...
public interface AlertService {
    ...
    AlertCommentImport addComment(AlertCommentImport comment) throws ZMonException;

    List<AlertCommentImport> getComments(int alertDefinitionId, int limit, int offset);
