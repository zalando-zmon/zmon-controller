package org.zalando.zmon.utils;
...
public class NamedMessageFormatterTest {
    ...
    public void testGroupReference() throws Exception {
        Assert.assertEquals(
            "CaMP Exceptions Overview last hour: org.zalando.angularjs.rpc.RPCMethodHandler$RPCInvocationTargetException: 35",
            messageFormatter.format("CaMP Exceptions Overview last hour: {problems}",
                ImmutableMap.<String, Collection<String>>of("problems",
                    ImmutableList.of("org.zalando.angularjs.rpc.RPCMethodHandler$RPCInvocationTargetException: 35"))));
    }
