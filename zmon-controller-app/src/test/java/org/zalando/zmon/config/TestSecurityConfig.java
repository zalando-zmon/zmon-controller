...
public class TestSecurityConfig {
    ...
    public ResourceServerConfigurer testResourceServerConfigurer(ZauthProperties zauthProperties) throws MalformedURLException {
        ...
        final ZauthProperties zauthPropertiesSpy = spy(zauthProperties);
        when(zauthPropertiesSpy.getUserServiceUrl()).thenReturn(new URL("http://user-service.com"));

        final AuthorityService authorityService = new ZauthAuthorityService(zauthPropertiesSpy, teamServiceMock, accessTokens) {
            @Override
        ...
        final ZmonAuthenticationExtractor extractor = new ZmonAuthenticationExtractor(authorityService, teamServiceMock);
