...
public interface CheckDefinitionSProcService {
    ...
    @SProcCall
    CheckDefinitionImportResult createOrUpdateCheckDefinition(@SProcParam CheckDefinitionImport checkDefinition, @SProcParam String userName, @SProcParam List<String> teams);
