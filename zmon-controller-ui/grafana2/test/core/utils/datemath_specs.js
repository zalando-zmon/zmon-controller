define(["require", "exports", 'test/lib/common', 'app/core/utils/datemath', 'lodash', 'moment'], function (require, exports, common_1, dateMath, _, moment) {
    common_1.describe("DateMath", function () {
        ...
        common_1.describe('relative time to date parsing', function () {
            common_1.it('should handle negative time', function () {
                ...
                common_1.expect(date.valueOf()).to.equal(moment([2014, 1, 3]).valueOf());
            });
            common_1.it('should handle multiple math expressions', function () {
                var date = dateMath.parseDateMath('-2d-6h', moment([2014, 1, 5]));
                common_1.expect(date.valueOf()).to.equal(moment([2014, 1, 2, 18]).valueOf());
            });
