...
define(["require", "exports", "test/specs/helpers", 'test/lib/common', "app/plugins/datasource/graphite/datasource"], function (require, exports, helpers, common_1) {
    common_1.describe('graphiteDatasource', function () {
        ...
        common_1.beforeEach(ctx.createService('GraphiteDatasource'));
