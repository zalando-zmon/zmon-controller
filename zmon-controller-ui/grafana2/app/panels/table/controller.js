...
define(["require", "exports", 'lodash', 'app/features/panel/panel_meta', './table_model'], function (require, exports, _, PanelMeta, table_model_1) {
    var TablePanelCtrl = (function () {
        ...
        function TablePanelCtrl($scope, $rootScope, $q, panelSrv, panelHelper, annotationsSrv) {
            ...
            $scope.render = function () {
                $scope.table = table_model_1.TableModel.transform($scope.dataRaw, $scope.panel);
